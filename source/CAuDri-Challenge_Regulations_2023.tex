%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                                                                                                    %%
%% This is the source file for the official CAuDri-Challenge 2023 regulations.                        %%
%%                                                                                                    %%
%% Can be compiled with PDFLaTeX, packages are strictly necessary.                                    %%
%% All graphics can be found on our OneDrive in CAuDri-Challenge\Regelwerk\2023\Source\graphics       %%
%%                                                                                                    %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\fancyhead[L]{\large CAuDri-Challenge Regulations 2023}
\fancyhead[R]{\includegraphics[width=3cm]{source/graphics/caudri_logo_no_border.jpg}\hspace{-5mm}
              \vspace{-3mm}}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[scale=0.8]{source/graphics/Abb_1_parking_lot.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_2_parallel_parking.pdf}
\end{center}
\end{figure}
...
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_3_perpendicular_parking.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_4_road_layout.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_5_intersection.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_6_intersection_give_way.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[width=\textwidth]{source/graphics/Abb_8_barred_area.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_9_crosswalk.pdf}
\end{center}
\end{figure}
\newpage
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_10_pedestrian_island.pdf}
\end{center}
\end{figure}
\newpage
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_11_pedestrian_island_crosswalk.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_12_intersection_give_way_lines.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_13_intersection_priority.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_14_mandatory_stop.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_15_mandatory_give_way.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_16_mandatory_right_of_way.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[width=\textwidth]{source/graphics/Abb_17_road_markings.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_18_traffic_signs.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_19_positioning_of_traffic_signs.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_20_obstacles.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[]{source/graphics/Abb_21_pedestrians.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[width=\textwidth]{source/graphics/Abb_22_example_circuit.pdf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
	\centering\includegraphics[width=\textwidth]{source/graphics/Abb_23_start_box_markings.pdf}
\end{center}
\end{figure}
