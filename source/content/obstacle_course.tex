...
referee, signaled by the opening of the start box gate.\\ It is not
...
\subsection{Scoring}{
	...
	\colorbox{yellow}{\large\textbf{Complete Overhaul of the Scoring System}}\\
	...
	event starts with the opening of the start box gate, described in
