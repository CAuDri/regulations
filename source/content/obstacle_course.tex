...
\begin{highlight}
	...
	spots are indicated by the corresponding traffic sign. \HighlightNew{(Note:
...
\subsection{Scoring}{
	...
	\begin{highlight}
		...
		\begin{table}[H]
			\begin{tabularx}{\textwidth}{XXX}
				...
				\textbf{Positive}                      & \textbf{Neutral}                           & \textbf{Negative}                              \\
				\midrule
				Stopped at the stop or give-way line   & Distance from stop or give-way line > 15cm & Did not stop at the stop line \footnotemark[2] \\
				Went straight through the intersection & Made a wrong turn \footnotemark[3]         &                                                \\
		...
		\begin{table}[H]
			\begin{tabularx}{\textwidth}{XXX}
				...
				\midrule
				Stopped at the stop or give-way line & Distance from stop or give-way line > 15cm & Did not stop at the stop line \footnotemark[2] \\
				Took the correct turn                & Made a wrong turn \footnotemark[3]         &                                                \\
				                                     & Stopped for < 3s at stop line              &                                                \\
				                                     & Stopped for < 1s at give-way line          &                                                \\
				\topstrut
		...
		\footnotetext[2]{Only applies for stop and not for give-way line}
		\footnotetext[3]{Includes driving straight incorrectly}
		\newpage
	...
	\begin{table}[H]
		\begin{tabularx}{\textwidth}{XXX}
			...
			\textbf{Positive}                         & \textbf{Neutral}                                    & \textbf{Negative}           \\
			\midrule
			Stopped at the crosswalk \footnotemark[4] & Stopped for < 3s at the crosswalk \footnotemark[4]  & Collision with a pedestrian \\
			Pedestrians have cleared the crosswalk    & Distance from the crosswalk > 15cm \footnotemark[4] &                             \\
	...
	\footnotetext[4]{If a pedestrian is present}
	\newpage
