...
\subsection{Scoring}{
	...
	\subsubsection*{\HighlightNew{Intersection Obstacles}}
	\begin{table}[H]
		\begin{tabularx}{\textwidth}{XXX}
			\toprule
			\textbf{Positive}                & \textbf{Neutral}                & \textbf{Negative}          \\
			\midrule
			Respected the right-of-way 				& Did not respect the right-of-way 					& Collision with an Obstacle	\\
	...
	\subsubsection*{\HighlightNew{Stop and Give-Way Intersection}}
	\begin{table}[H]
		\begin{tabularx}{\textwidth}{XXX}
			\toprule
			\textbf{Positive}                & \textbf{Neutral}                & \textbf{Negative}          \\
	...
	\subsubsection*{\HighlightNew{Priority-to-Right Intersection}}
	\begin{table}[H]
		\begin{tabularx}{\textwidth}{XXX}
			\toprule
			\textbf{Positive}                & \textbf{Neutral}                & \textbf{Negative}          \\
	...
	\subsubsection*{\HighlightNew{Mandatory Direction Intersection}}
	\begin{table}[H]
		\begin{tabularx}{\textwidth}{XXX}
			\toprule
			\textbf{Positive}                & \textbf{Neutral}                & \textbf{Negative}          \\
	...
	\begin{table}[H]
		\begin{tabularx}{\textwidth}{XXX}
			...
			\textbf{Positive}                                       & \textbf{Neutral}                   & \textbf{Negative}          \\
			\midrule
			Stayed in the right lane		& Started a passing maneuver 		& Collision with an Obstacle \\
	...
	\begin{table}[H]
		\begin{tabularx}{\textwidth}{XXX}
			...
			\textbf{Positive}                                           & \textbf{Neutral}                                                  & \textbf{Negative}          \\
			\midrule
			Did not enter the barred area                  	& Entered the barred area                        	& Collision with an obstacle	\\
			Respected the right-of-way \footnotemark[1] 	& Did not respect the right-of-way \footnotemark[1] 	&                            	\\
	...
	\begin{table}[H]
		\begin{tabularx}{\textwidth}{XXX}
			...
			\textbf{Positive}                                               & \textbf{Neutral}                                                   & \textbf{Negative}           \\
			\midrule
			Stopped at the crosswalk \footnotemark[2]       		& Stopped for < 3s at the crosswalk \footnotemark[2] 				& Collision with a pedestrian	\\
			Pedestrians have cleared the crosswalk \footnotemark[2]	& Distance from the crosswalk > 15cm \footnotemark[2]   				&                             	\\
			                                                        & Pedestrians have not fully cleared the crosswalk \footnotemark[2]	&                             	\\
			\topstrut
			\textbf{+15}                                                    & \textbf{0}                                                         & \textbf{-10}                \\
			\bottomrule
		\end{tabularx}
	...
	\footnotetext[1]{In case an Obstacle is present}
