...
\subsection{Scoring}{
	...
	When the vehicle passes one of the elements described in section \ref{track_layout} and \ref{elements_obstacle_evasion}, it will receive either a positive, neutral or negative evaluation.
