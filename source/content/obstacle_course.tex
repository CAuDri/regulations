...
\subsection{Scoring}{
	...
	\begin{highlight}
		...
		\footnotetext[1]{If the obstacle has the right-of-way, e.g. at a barred area}
		\newpage
		...
		\footnotetext[1]{Only applies for stop and not for give-way line}
		\footnotetext[2]{Includes driving straight incorrectly}
		\newpage
	...
	\footnotetext[1]{If a pedestrian is present}
	\newpage
