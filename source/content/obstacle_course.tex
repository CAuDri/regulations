...
Additionally, the vehicle has to perform automatic parking maneuvers by finding
a suitable parking spot inside a parking lot. The track does additionally
...
\ref{traffic_signs}). The suburban area contains a parking lot which is
indicated by the parking traffic sign. (cf. Section \ref{fig_parking_lot})
...
perpendicular parking. Parking areas are announced by the corresponding traffic
sign (cf. Section \ref{fig_parking_lot}). The parking area is a planar and
straight part of the track with a dashed center line without missing lane
markings. Additional elements (intersections, missing lane markings, traffic
...
\ref{fig_parallel_parking}). Approaching from the parking sign, the parking
spots will be growing in length. The final and largest spot will be at least
700 mm in length. Nevertheless, small distances of under 400 mm might be
present between obstacles anywhere inside the parallel parking area(s).
...
have to turn left or right according to these regulations and signal this
accordingly with their turn indicators. In the intersection, the mandatory
direction will additionally be indicated by dashed turn lines that continue the
center line and the right lane boundary. Turn lines cannot be missing.
...
spots are indicated by the corresponding traffic sign.
...
located in a valid spot with all of its wheels and flash all turn indicators at
least one time. While maneuvering out of the parking spot, the vehicle may
cross the left lane, but has to continue driving in the right lane after the
parking maneuver.
...
leaving the right lane while driving. The speed in the parking lot is limited
to the speed on the adjacent road. Collisions with obstacles during the parking
maneuver will be penalized.
