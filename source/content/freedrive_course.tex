...
intersections, and side road junctions. The lanes are limited by different types of
...
will be placed at least 1000 mm prior to any change of slope. 

All of the lane markings can be missing at arbitrary locations for a maximum of 
1000 mm. Except for intersections, no more than two markings are missing at the same time.

An example scenario is depicted in Section \ref{fig_example_circuit} in the
appendix.

The vehicle has to stay in the right lane at all times. Crossing the lane markings with two or more wheels will result in a penalty.
...
The attempt may be canceled while the gate of the start box is open, even after
the vehicle left the start box. The start box is open for 30s. The team
