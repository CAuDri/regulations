...
\colorbox{yellow}{\parbox{\colorboxwidth}{During normal driving, the vehicle
has to stay in the right lane. It must not cross the lane markings with more
than two wheels, otherwise a penalty will result.}}
...
covered. Collisions during parking attempts result in \HighlightNew{the attempt 
becoming invalid}. The best parking results will be considered 
...
attempt by finding a \HighlightNew{valid} parking spot within the parking areas and maneuver into
...
located in a valid spot with \HighlightNew{all} of its wheels and flash all turn
