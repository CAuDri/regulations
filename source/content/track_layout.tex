...
Not all track elements are part of every event.
...
\begin{highlight}
    ...
    A valid track will always have a designated route that is implicitly defined by the track layout and included track elements.
\end{highlight}
...
Static obstacles are used to represent other parked vehicles and can be fixed to the ground, \HighlightNew{however they cannot occur in either driving lane}.
