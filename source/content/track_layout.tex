...
\HighlightNew{The dynamic obstacle may proceed straight, turn left, or turn right, and shall comply with the intersections priority regulations, such as priority-to-the-right, give-way, or stop signs.}
...
\begin{minipage}[t]{0.78\textwidth}
    ...
    \HighlightNew{After the no-passing zone no other element can occure for 2000 mm.}
\end{minipage}
\hfill
\begin{minipage}[t]{0.12\textwidth}
    \vspace{0pt}
