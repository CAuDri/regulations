...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[scale=0.8]{graphics/Abb_1_parking_lot}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_2_parallel_parking}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{center}
		\centering\includesvg[]{graphics/Abb_3_perpendicular_parking}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_4_road_layout}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_5_intersection}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_6_intersection_give_way}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_7_speed_limit_zone}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[width=\textwidth]{graphics/Abb_8_barred_area}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_9_crosswalk}
	\end{center}
\end{figure}
\newpage
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_10_pedestrian_island}
	\end{center}
\end{figure}
\newpage
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_11_pedestrian_island_crosswalk}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_12_intersection_give_way_lines}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_13_intersection_priority}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_14_mandatory_stop}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_15_mandatory_give_way}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_16_mandatory_right_of_way}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[width=\textwidth]{graphics/Abb_17_road_markings}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_18_traffic_signs}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_19_positioning_of_traffic_signs}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_20_obstacles}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[]{graphics/Abb_21_pedestrians}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[width=\textwidth]{graphics/Abb_22_example_circuit}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\centering\includesvg[width=\textwidth]{graphics/Abb_23_start_box_markings}
	\end{center}
\end{figure}